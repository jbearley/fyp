...
def elective_dictionary(choose_table):
    ...
    elif choose_table=="Business Law":
        choose_table= ["FIRST_BL_PICK_ONE", "SECOND_BL_PICK_ONE", "CHOOSE_THREE_BLAW"]
    ...
    for item in choose_table:
        ...
        query_1 = "SELECT CLASSES.ClassID, Prereqs FROM dbo.CLASSES, dbo." + item + " WHERE CLASSES.ClassID =" + item + ".ClassID"
        ...
        query_2 = "SELECT CLASSES.ClassID, Fall, Spring FROM dbo.CLASSES, dbo." + item + " WHERE CLASSES.ClassID =" + item + ".ClassID"
        ...
        query_3 = "SELECT CLASSES.ClassID, Credits FROM dbo.CLASSES, dbo." + item + " WHERE CLASSES.ClassID =" + item + ".ClassID"
        ...
        query_4 = "SELECT CLASSES.ClassID, GradeReq FROM dbo.CLASSES, dbo." + item + " WHERE CLASSES.ClassID =" + item + ".ClassID"
        ...
        query_5 = "SELECT CLASSES.ClassID, Coreq FROM dbo.CLASSES, dbo." + item + " WHERE CLASSES.ClassID =" + item + ".ClassID"
        ...
        query_7 = "SELECT CLASSES.ClassID, Odd, Even FROM dbo.CLASSES, dbo." + item + " WHERE CLASSES.ClassID =" + item + ".ClassID"
        ...
        query_8 = "SELECT CLASSES.ClassID, Credits FROM dbo.CLASSES, dbo." + item + " WHERE CLASSES.ClassID =" + item + ".ClassID"
        ...
        query_9 = "SELECT CLASSES.ClassID, CLASSES.ClassName FROM dbo.CLASSES, dbo." + item + " WHERE CLASSES.ClassID =" + item + ".ClassID"
...
print(elective_dictionary("Economics"))