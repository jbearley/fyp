...
print("\n")
query_10 = f"""
SELECT * FROM dbo.FIRST_BL_PICK_ONE
"""
cursor.execute(query_10)
result_10 = cursor.fetchall()
print("This is the first business law pick one table:")
for tup in result_10:
    print(tup)

print("\n")
query_11 = f"""
SELECT * FROM dbo.SECOND_BL_PICK_ONE
"""
cursor.execute(query_11)
result_11 = cursor.fetchall()
print("This is the second business law pick one table:")
